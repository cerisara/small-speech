...
import static fr.xtof54.jtransapp.StatePool.SILENCE_PHONE;
...
public class Token {
	...
	public static class Segment {
		...
		public float getStartSecond() {
			return HMMModels.frame2second(start);
		}

		public float getEndSecond() {
			return HMMModels.frame2second(end);
		}
		...
		public float getLengthSeconds() {
			return HMMModels.frame2second(getLengthFrames());
		}
	}
